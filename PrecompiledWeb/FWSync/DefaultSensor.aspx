<%@ page language="C#" masterpagefile="~/master/OutdoorSensorMasterPage.master" autoeventwireup="true" inherits="DefaultSensor, App_Web_um3uhlng" %>
...
<table style="width:1180px;height:500px;text-align:center">
    <tr>
        ...
        <td rowspan="2" style="width: 800px">
            ...
            <dl id="poorMap">
		        <dd><a id="v1_4" title="1-4" href="javascript:void(0);" onclick="initVideoSys('11');"></a></dd>
		        <dd><a id="v1_2" title="1-2" href="javascript:void(0);" onclick="initVideoSys('14');"></a></dd>
		        <dd><a id="v5_6" title="5-6" href="javascript:void(0);" onclick="initVideoSys('12');"></a></dd>		
		        <dd><a id="v7_6" title="7-6" href="javascript:void(0);" onclick="initVideoSys('13');"></a></dd>
